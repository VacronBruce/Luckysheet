...
* **api:** api ([6f7ca26](https://github.com/VacronBruce/Luckysheet/commit/6f7ca26ba22c47ed0746363dccfd1e392040aed9))
...
* **editor box position fit:** show diffrent position acording to align ([636046d](https://github.com/VacronBruce/Luckysheet/commit/636046dbb2f005c2e6110b3559b72a59a7c67d87))
...
* **scroll style fix beautify:** scroll,sheet color and style ([63f2630](https://github.com/VacronBruce/Luckysheet/commit/63f2630b95ab811807199670db6eee332af882a8))
...
* 新增图片单独上传，只在数据中留地址的实现 ([f1818ad](https://github.com/VacronBruce/Luckysheet/commit/f1818ada5022d1f32eedade9e186c9f670b45619))
...
* **bug:** bug ([a8ff967](https://github.com/VacronBruce/Luckysheet/commit/a8ff967be9cdcf3bbcb0045888951a26a852500a)), closes [#398](https://github.com/VacronBruce/Luckysheet/issues/398)
...
* **bug:** bug ([ba0b047](https://github.com/VacronBruce/Luckysheet/commit/ba0b04752f35f32df82229339bdb3f295fbcecb2))
...
* **bug:** 二次create时，不能进行更改颜色 ([85e3737](https://github.com/VacronBruce/Luckysheet/commit/85e3737e3ac9bf6e4082687fb41e5b917abf3403))
...
* **cursorPos:** 修复 event.target 为 document 等情况下代码报错的问题 ([45f0aea](https://github.com/VacronBruce/Luckysheet/commit/45f0aea5484d7e8aaf5aac15f02fa14a89506fd8))
...
* **fix #209 fix #219:** highlight follow, checkout keep highlight ([2c7b0bb](https://github.com/VacronBruce/Luckysheet/commit/2c7b0bbdf5adf1b2a6fc537e37825ab01ee3cf96)), closes [#209](https://github.com/VacronBruce/Luckysheet/issues/209) [#219](https://github.com/VacronBruce/Luckysheet/issues/219)
...
* **formula:** ask ai function ([0abd26a](https://github.com/VacronBruce/Luckysheet/commit/0abd26a9db889e226d2081628cdb701d7c465df9))
...
* **green label size fix:** fix ([b0734b5](https://github.com/VacronBruce/Luckysheet/commit/b0734b57bb42c55e99eb831c0ca24053ea4aa6a8))
...
* jfrefreshgrid 函数第二个参数应该是个数组 ([c7cf87a](https://github.com/VacronBruce/Luckysheet/commit/c7cf87a49b1b8ce64fb21249cd05950fabc0e546))
...
* **pivot table filter bug:** change sheet bug ,after filter pivot table ([c7c1999](https://github.com/VacronBruce/Luckysheet/commit/c7c1999081289c70b6e575e9e37fae82bdfe438c))
...
* **sheet name contains squotes bug:** formla can not execute, when sheet name contains squotes ([fc1dd83](https://github.com/VacronBruce/Luckysheet/commit/fc1dd837d4a3d1639914923201e853e55a865143))
...
* 修复 setCellValue 方法bug 仅当新设置的单元格不含有公式时才能删除原公式链 ([3e52213](https://github.com/VacronBruce/Luckysheet/commit/3e52213e4fb3b107df13e3d3ed926b049553efa1))
...
* 修复存在滚动时 点击冻结首行 实际冻结的是当前视图第一行的bug ([d192b3c](https://github.com/VacronBruce/Luckysheet/commit/d192b3cf34c3021453443949cd6804bfb30e9e75))
...
* 修复指定order下标为0（第一个sheet） ([fb2e866](https://github.com/VacronBruce/Luckysheet/commit/fb2e8668cc17ff24ae685b5e4bf8c8b8af6ed7f0))
* 修复换行单元格在mergecell时内容丢失的bug ([1c6e44c](https://github.com/VacronBruce/Luckysheet/commit/1c6e44c0f0bd4706b5d16f713d2199e361df1915))
* 修复数据透视 数据声明bug ([a53e6af](https://github.com/VacronBruce/Luckysheet/commit/a53e6af0dc068d4d15d9c624d49eb5877e0e4922))
* 修复添加sheet后的数据丢失问题. ([7956748](https://github.com/VacronBruce/Luckysheet/commit/7956748e652f136a5fedfc9ef1435148434e6c5d))
* 修复添加sheet时，接受OP方的sheet滚动按钮显示问题 ([5f9ac14](https://github.com/VacronBruce/Luckysheet/commit/5f9ac1490fe57cdb0351ed6db552711eda38f0f5))
* 修复点击冻结首列再点击取消冻结的情况下，工具栏仍显示取消冻结的问题 ([4e4e952](https://github.com/VacronBruce/Luckysheet/commit/4e4e952f9ffc065e06f700168de204f81d7bf073))
* 修复点击冻结首行首列的滚动问题 ([009205e](https://github.com/VacronBruce/Luckysheet/commit/009205eb754babd96d22f41edc6715219d2f6e68))
* 修复英文下，合并单元格的拓展菜单UI显示问题 ([64a51d3](https://github.com/VacronBruce/Luckysheet/commit/64a51d37f56164ca0087b8906cb420fc5a99bf09))
* 修复英语语种下，插入链接弹窗的链接地址栏显示错误问题 ([0629f29](https://github.com/VacronBruce/Luckysheet/commit/0629f29eb9599b12a44a9fd178249a9fcf8a5566))
* 修复获取sheet数据时chartOptions不完整 ([7a1baa4](https://github.com/VacronBruce/Luckysheet/commit/7a1baa415471933aff70c91a2d02502f7e687506))
* 修复调用 setSheetZoom API时图片未更新的问题 ([44a2776](https://github.com/VacronBruce/Luckysheet/commit/44a27766b3a5afb8f7c71cbf0ad714548a8d68a8))
* 修复重命名sheet为空时的tooltip导致无法进行下一步任何操作的问题 ([68d1132](https://github.com/VacronBruce/Luckysheet/commit/68d113201c69fa54cdab1f5ddf80ac1f7938cccd))
* 修复重构工具栏配置后不传 showtoolbar showtoolbarConfig 时的bug ([4dd527b](https://github.com/VacronBruce/Luckysheet/commit/4dd527b6cf649a62e460f4664666db4d3081e293))
* 修复隐藏和删除sheet时，右下角的滚动按钮不会重新计算的问题 ([163a344](https://github.com/VacronBruce/Luckysheet/commit/163a344ed6b784b02630aa10f650b94c35e09f49))
* 冻结使用更贴切的文案描述 ([c28659e](https://github.com/VacronBruce/Luckysheet/commit/c28659e2516297a4bc7042ccc368dac43d82caf7))
* 初始化表单状态下标调整 ([3a54312](https://github.com/VacronBruce/Luckysheet/commit/3a54312c93a6daebf575639dd612e0d01be2a296))
* 加个标志位，控制冻结首行首列到底是指可是区域还是实际的 ([f265b63](https://github.com/VacronBruce/Luckysheet/commit/f265b631701b0ba6c5d505d27354e95285953f68))
* 取消冻结无须打勾 ([65da5b9](https://github.com/VacronBruce/Luckysheet/commit/65da5b9c653b70e0a816526b0a43b9e9c7dab10f))
* 只取第一个body元素 ([b040165](https://github.com/VacronBruce/Luckysheet/commit/b040165cd5b12462e061960fa89c4e2d93638bc3))
* 复制选区虚线框正确显示 ([9d6a2ee](https://github.com/VacronBruce/Luckysheet/commit/9d6a2eed05ae660fb65515217e156817fc4d6443))
* 对第表格一列的左侧添加列时，添加出来的列数据会同步的问题. ([035ebe5](https://github.com/VacronBruce/Luckysheet/commit/035ebe51c394089db19401f68ddb3a7b8e1b02c6))
* 换行 ([94022a4](https://github.com/VacronBruce/Luckysheet/commit/94022a48b6407523c5924e94c86fb2ada0fab301))
* 点击【transpose(switch row/column)】按钮 报错 [#6](https://github.com/VacronBruce/Luckysheet/issues/6) ([1f5c434](https://github.com/VacronBruce/Luckysheet/commit/1f5c434b107d3300a600f0d5531dca809ba60967))
* 移除 console ([c511651](https://github.com/VacronBruce/Luckysheet/commit/c511651f94957379c1738fbf80ad51a29316506d))
* 粘贴事件会注册多次，导致多次打开后，粘贴内容的重复次数会和打开次数相同 ([2c36f26](https://github.com/VacronBruce/Luckysheet/commit/2c36f2608927d306db96686a27c39a9660767184))
* 统一命名 ([f9e383c](https://github.com/VacronBruce/Luckysheet/commit/f9e383c193aee1a9a3215e5cf52075691bd91a9f))
* 解决allowEdit为false时仍然允许进行边框编辑的问题。 ([bf47a7f](https://github.com/VacronBruce/Luckysheet/commit/bf47a7f6201d2c483fd26b4bcb60163d686f17a4))
* 解决allowEdit为false时仍然可以进行单元格合并拆分的问题 ([a52626a](https://github.com/VacronBruce/Luckysheet/commit/a52626a7c56a05406ce88ef577d51f1b4dcba2ad))
* 解决allowEdit为false时允许上传图片的问题 ([76194a3](https://github.com/VacronBruce/Luckysheet/commit/76194a38c040e8fe30343377dbaead97b5ef3114))
* 解决单击非时间日期单元格后还会跳出日期时间弹框 ([fc9eb4e](https://github.com/VacronBruce/Luckysheet/commit/fc9eb4e7984af6991b79acae6a2a5c0bbea5254f))
* 解决容器id不是luckysheet时，点击工具栏中 “更多” 按钮，出现的偏移位置出错的问题 ([022714f](https://github.com/VacronBruce/Luckysheet/commit/022714f79a37dabc54530c9406e28049cfcb6e94))
* 解决有隐藏列时过滤数据错乱的问题 ([22ad24c](https://github.com/VacronBruce/Luckysheet/commit/22ad24c3dac8d9b9f86fdb32304eb36ccd46a55d))
* 重复create会出现很多问题 ([8f22790](https://github.com/VacronBruce/Luckysheet/commit/8f227904fe9600ea17fdc346924d73c3bc81a041))
* 防止创建重复的chart dom ([d6c7f2c](https://github.com/VacronBruce/Luckysheet/commit/d6c7f2cad977f6c5c337132ad0e54881c5e2986c))


### build

* **gulp:** gulpfile,index.html,pack js css ([8be0467](https://github.com/VacronBruce/Luckysheet/commit/8be0467dea483be7be2a5af1bc3545a04a67ea72))


* **all project:** modular,Document promotion,Some bugs ([37c3070](https://github.com/VacronBruce/Luckysheet/commit/37c307087cb50efa9eb3e1f3a22a356024aa43b5)), closes [#11](https://github.com/VacronBruce/Luckysheet/issues/11) [#2](https://github.com/VacronBruce/Luckysheet/issues/2)
* **api:** api ([f19a26e](https://github.com/VacronBruce/Luckysheet/commit/f19a26eab08bc44a5c380afd883d4e730f681062))
